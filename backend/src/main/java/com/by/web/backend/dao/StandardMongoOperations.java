 ...
 * Mongo Operation
 *
 * This is the abstract mongo operations which packed several simple
 * mongoTemplate
 * methods.
 *
 ...
 *
 * <p>
 * About the route to the destination collection, if need to define by yourself,
 * </p>
...
public abstract class StandardMongoOperations<T> {
     ...
     * <p>
     * This function supports mongodb specific search and page function.
     * </p>
     * <p>
     ...
     */
    public PageModel<List<T>> roughAndPageableSearch(boolean isRough, String searchString, String searchItem,
